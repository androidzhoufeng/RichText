...
public class RichEditImageGetter implements Html.ImageGetter {private HashSet<Target> targets;
    private HashSet<GifDrawable> gifDrawables;
    private final Context mContext;
    private final EditText mTextView;
    public RichEditImageGetter(Context context, EditText textView) {
    ...
    class BitmapTarget extends SimpleTarget<Bitmap> {
        ...
        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
            ...
            int padding = dip2px(mContext,30);
